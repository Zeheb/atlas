...
from atlas.eval.cases import CAP_QUESTION_RETRIEVAL, CAP_RETRIEVAL_PLAN, EvalCase, load_cases
...
def _case() -> EvalCase:
    return EvalCase(
        id="rp-test", category="A", question=_QUESTION, subject="TCS",
        expected_behavior="answer", rubric="plan-conditioned retrieval",
    )
