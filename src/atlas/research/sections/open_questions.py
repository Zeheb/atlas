...
def _thin_metrics(profile: CompanyProfile, basis: str = "consolidated", period_type: str = "annual") -> list[str]:
    thin = []
...
def build(
    ...
    notes = []
    if not findings:
        notes.append("No material gaps identified in the data reviewed for this report.")
